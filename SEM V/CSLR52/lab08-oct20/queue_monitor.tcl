# gawk '{ print $1, $4 }' monitor.out > monitor_plot.pre
# plot "monitor_plot.pre" using 1:2 title "Flow 1" with lines 1
...
# ####################################################################
# Queue Monitoring
  # set link [$ns simplex-link $n2 $n3 0.3Mb 2000ms Dr]

  set file1 [open monitor.out w]
